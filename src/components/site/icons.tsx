...
/** Stroke icon wrapper giving a consistent 24px artboard. */
...
/* Brand-style marks below use fill (brand glyphs are not stroke icons). */

export function GitHubIcon(props: IconProps) {
  return (
    <svg
      width={(props.size ?? 20) as number}
      height={(props.size ?? 20) as number}
      viewBox="0 0 24 24"
      fill="currentColor"
      aria-hidden="true"
      {...props}
